        ...
        <div style={{
          ...
          <div>
            <span style={{
              ...
              color: 'rgba(255,255,255,0.3)', display: 'block', marginBottom: '20px',
            }}>THE STUDIO</span>
            <h2 style={{
          ...
          <div style={{ paddingBottom: '8px' }}>
            <p style={{
              ...
              fontSize: '14px', lineHeight: 1.85, color: 'rgba(255,255,255,0.55)',
              maxWidth: '400px',
            }}>
            ...
            <p style={{
              fontFamily: 'Inter, sans-serif', fontWeight: 300,
              fontSize: '14px', lineHeight: 1.85, color: 'rgba(255,255,255,0.35)',
